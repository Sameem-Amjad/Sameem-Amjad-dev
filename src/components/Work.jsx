    ...
    <div className="container mx-auto">
      <div className='flex flex-row lg:flex-row gap-x-5'>
        <motion.div
          ...
          className='flex-1 flex flex-col gap-y-8 pt-1 mb-10 lg:mb-0 '>
          {/* text */}
          <div>
            ...
            <button className='btn btn-sm animate-pulse border-2 focus:ring-2 focus:ring-purple-400' >View all projects</button></Link>
          </div>
          {/* image */}
